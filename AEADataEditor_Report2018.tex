...
%\textbf{We are currently finalizing contract terms and addressing technical improvements with such a data archive, and expect a decision to be made in time for the Meetings, and the repository to be available for new deposits in 2019Q2.} 
...
%\footnote{A paper describing the schema \citep{VilhuberInt.J.Digit.Curation2019} is scheduled to be presented at the International Digital Curation Conference (IDCC) in February 2019 and is currently being reviewed at the International Journal of Digital Curation.} 
...
\tiny
\csvautobooktabular{text/includes/journal_by_year.csv}
...
Second, the variety of software is relatively small. %Figure~\ref{fig:aer_programs_by_year} shows the distribution of software in  on the AEA website. 
...
%\includegraphics[width=0.40\textwidth]{images/aer_programs_by_year.png}
%%   
%%  &
...
%
%%\end{tabular}
%\caption{Popularity of statistical software in the AER\label{fig:aer_programs_by_year}}
%\begin{figurenotes}
%	Software usage based on filename extensions in ZIP files of replication materials on the AEA website.
%\end{figurenotes}
...
/csv/filter not equal={\journal}{NA},
tabular=lllll,
table head=\toprule Journal & Stata & Matlab & R & SAS \\\midrule,%
table foot=\bottomrule,%
%/csv/late after line={,},%
%/csv/late after last line=.,%
]%
{text/includes/software_by_journal_pct.csv}{}{\journal & \Stata &\Matlab &\R &\SAS}
\begin{tablenotes}
...
%The board has recently appointed a Data Editor there as well, and we look forward to collaborations. We have also discussed with editors of the Journal of Labor Economics, the Industrial and Labor Relations Review, the Journal of Human Resources, and Sociological Sciences. 
...
%\footnote{For the technically inclined, this process involves updating an existing style or creating a new style on \url{https://citationstyles.org/} and \url{https://github.com/citation-style-language/styles}, from where it propagates to a large number of software packages.} 
...
%\footnote{I have also produced a draft update to the Bibtex style distributed by the AEA (\texttt{aea.bst}), see  \url{https://github.com/AEADataEditor/aea-de-guidance/blob/master/citations/aea-mod.bst} to download.}
...
The document, data, and programs for this report are available at \url{https://github.com/AEADataEditor/report-aea-data-editor-2018-interim/releases/tag/v20181208-sent}.
